...
if __name__ == '__main__':
    ...
    TOTAL_NUM_SYSTEMS = 500000 #total number of systems you want in the end
    ...
    pmc_object = pmc.Pmc(TOTAL_NUM_SYSTEMS, NUM_CPU_CORES, NUM_SYSTEMS_PER_RUN, output_folder, output_filename, debug = debug, run_on_helios = run_on_helios, mc_only = mc_only)
    ...
    pmc_object.initialize(dimensions, interesting_systems, configure_code_run, rejected_systems, update_properties_method = update_properties)
