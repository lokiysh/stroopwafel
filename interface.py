...
NUM_BATCHES = 5 #Number of batches you want to run in parellel
NUM_SAMPLES_PER_BATCH = 50 #Number of samples generated by each of the batch
...
sw = Stroopwafel(NUM_DIMENSIONS, NUM_BINARIES, NUM_BATCHES, NUM_SAMPLES_PER_BATCH, debug = debug, run_on_helios = run_on_helios, mc_only = mc_only)
...
def create_dimensions():
    ...
    a = Dimension('Separation', -1, 3, Sampler.flat_in_log, Prior.flat_in_log)
    kick_velocity_random_1 = Dimension('Kick_Velocity_Random_1', 0, 1, Sampler.uniform, Prior.uniform)
    kick_theta_1 = Dimension('Kick_Theta_1', 0, np.pi, Sampler.uniform, Prior.uniform)
    kick_phi_1 = Dimension('Kick_Phi_1', 0, 2 * np.pi, Sampler.uniform, Prior.uniform)
    kick_mean_anomaly_1 = Dimension('Kick_Mean_Anomaly_1', 0, 2 * np.pi, Sampler.uniform, Prior.uniform)
    kick_velocity_random_2 = Dimension('Kick_Velocity_Random_2', 0, 1, Sampler.uniform, Prior.uniform)
    kick_theta_2 = Dimension('Kick_Theta_2', 0, np.pi, Sampler.uniform, Prior.uniform)
    kick_phi_2 = Dimension('Kick_Phi_2', 0, 2 * np.pi, Sampler.uniform, Prior.uniform)
    kick_mean_anomaly_2 = Dimension('Kick_Mean_Anomaly_2', 0, 2 * np.pi, Sampler.uniform, Prior.uniform)
    return [m1, q, a, kick_velocity_random_1, kick_theta_1, kick_phi_1, kick_mean_anomaly_1, kick_velocity_random_2, kick_theta_2, kick_phi_2, kick_mean_anomaly_2]
