...
NUM_BATCHES = 20 #Number of batches you want to run in parellel
NUM_SAMPLES_PER_BATCH = 10000 #Number of samples generated by each of the batch
...
def create_dimensions():
    ...
    """
    m1 = Dimension('Mass_1', 5, 50, Sampler.kroupa, Prior.kroupa)
    q = Dimension('q', 0.25, 1, Sampler.uniform, Prior.uniform, should_print = False)
    a = Dimension('Separation', -1, np.log10(40), Sampler.flat_in_log, Prior.flat_in_log)
    kick_velocity_random_1 = Dimension('Kick_Velocity_Random_1', 0, 1, Sampler.uniform, Prior.uniform)
    kick_theta_1 = Dimension('Kick_Theta_1', -np.pi / 2, np.pi / 2, Sampler.uniform_in_sine, Prior.uniform_in_sine)
    kick_phi_1 = Dimension('Kick_Phi_1', -np.pi / 2, 3 * np.pi / 2, Sampler.uniform, Prior.uniform)
    kick_velocity_random_2 = Dimension('Kick_Velocity_Random_2', 0, 1, Sampler.uniform, Prior.uniform)
    kick_theta_2 = Dimension('Kick_Theta_2', -np.pi / 2, np.pi / 2, Sampler.uniform_in_sine, Prior.uniform_in_sine)
    kick_phi_2 = Dimension('Kick_Phi_2', -np.pi / 2, 3 * np.pi / 2, Sampler.uniform, Prior.uniform)
