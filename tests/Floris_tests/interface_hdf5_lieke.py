...
sys.path.append('/n/home04/lvanson/Programs/stroopwafel/') # Change to location of SW folder
from stroopwafel import sw, classes, prior, sampler, distributions, constants, utils, makeh5
...
def create_dimensions():
    ...
    """
    m1 = classes.Dimension('--initial-mass-1', 40, 100, sampler.kroupa, prior.kroupa)
