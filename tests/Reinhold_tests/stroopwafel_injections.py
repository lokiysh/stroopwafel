...
output_folder = '/home/rwillcox/output_oz101/nsk_PE/run1m/'           # Location of output folder (relative to cwd)                         
...
compas_root = os.environ.get('COMPAS_NSK_DIR')                              # Location of COMPAS installation
