"""
This file will contain all the necessary constants
"""
ALPHA_IMF = -2.3                        # power-law index initial mass function

# used for calculating ZAMS radii
R_COEFF =\
...
# why is there a difference between metallicity_sol and Zsol?
METALLICITY_SOL = 0.0142
ZSOL = 0.02
REJECTION_SAMPLES_PER_BATCH = 1e4        # test value to calculate rejection rate
TOTAL_REJECTION_SAMPLES = 1e6            # ditto
NUM_GENERATIONS = 10                     # number of GenAIS adaptation phases
MIN_ENTROPY_CHANGE = 0.01                # minimum improvement necessary to switch between generations
KAPPA = 1.0                              # adapted distribution width multiplier
